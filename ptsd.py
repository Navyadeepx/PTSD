...
a1 = Label(root, text='"Choose any tab to continue"', fg="grey")
...
def f1():
    ...
    b1 = Button(root, text="Enter", bg="grey", relief=SUNKEN, command=f1)
...
def f2():
    f0()
    Grid.rowconfigure(root, 4, weight=1)
    b1 = Button(root, text="Search", bg="grey", relief=SUNKEN, command=f2)
...
def f3():
    f0()
    Grid.rowconfigure(root, 4, weight=0)
    b1 = Button(root, text="Update", bg="grey", relief=SUNKEN, command=f3)
    n = "navyadeep"
...
def f4():
    f0()
    Grid.rowconfigure(root, 4, weight=0)
    b1 = Button(root, text="Delete", bg="grey", relief=SUNKEN, command=f4)
